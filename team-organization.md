...
- [**Team Organization Charter**](#team-organization-charter)
    - [**Team Goals** {#team-goals}](#team-goals-team-goals)
    - [**Mission Statement** {#mission-statement}](#mission-statement-mission-statement)
  - [**Presentation**](#presentation)
- [Appendix A: Team Organization {#appendix-a-team-organization}](#appendix-a-team-organization-appendix-a-team-organization)
    - [**Table of Contents**](#table-of-contents-1)
- [**User Needs, Benchmarking, and Requirements**](#user-needs-benchmarking-and-requirements)
    - [Identifying User Needs {#identifying-user-needs}](#identifying-user-needs-identifying-user-needs)
      - [Steps Taken {#steps-taken}](#steps-taken-steps-taken)
      - [Organizing and Refining User Needs {#organizing-and-refining-user-needs}](#organizing-and-refining-user-needs-organizing-and-refining-user-needs)
      - [Final User Needs {#final-user-needs}](#final-user-needs-final-user-needs)
    - [Benchmarking {#benchmarking}](#benchmarking-benchmarking)
      - [Key Products Benchmarked {#key-products-benchmarked}](#key-products-benchmarked-key-products-benchmarked)
      - [Findings {#findings}](#findings-findings)
    - [Converting User Needs into Specifications {#converting-user-needs-into-specifications}](#converting-user-needs-into-specifications-converting-user-needs-into-specifications)
      - [Translation into Quantifiable Metrics {#translation-into-quantifiable-metrics}](#translation-into-quantifiable-metrics-translation-into-quantifiable-metrics)
      - [Sample Specifications {#sample-specifications}](#sample-specifications-sample-specifications)
    - [Assessing the Design Against Requirements {#assessing-the-design-against-requirements}](#assessing-the-design-against-requirements-assessing-the-design-against-requirements)
      - [Aspects of Assessment {#aspects-of-assessment}](#aspects-of-assessment-aspects-of-assessment)
- [**Design Ideation** {#design-ideation}](#design-ideation-design-ideation)
    - [Climate Sensing Drone {#climate-sensing-drone}](#climate-sensing-drone-climate-sensing-drone)
    - [Weather Sensing Wizard's Hat {#weather-sensing-wizards-hat}](#weather-sensing-wizards-hat-weather-sensing-wizards-hat)
    - [Detachable Wizard's Orb {#detachable-wizards-orb}](#detachable-wizards-orb-detachable-wizards-orb)
- [**Design Ideation: Specification Assignment** {#design-ideation-specification-assignment}](#design-ideation-specification-assignment-design-ideation-specification-assignment)
    - [Roles of Each Team Member in Generating Ideas {#roles-of-each-team-member-in-generating-ideas}](#roles-of-each-team-member-in-generating-ideas-roles-of-each-team-member-in-generating-ideas)
      - [Haoyu Zhang {#haoyu-zhang}](#haoyu-zhang-haoyu-zhang)
      - [Mudit Lal {#mudit-lal}](#mudit-lal-mudit-lal)
      - [Gwen {#gwen}](#gwen-gwen)
      - [Kevin Ordorica {#Kevin Ordorica}](#kevin-ordorica-kevin-ordorica)
    - [Brainstorming Techniques: What Worked and What Didn’t {#brainstorming-techniques-what-worked-and-what-didn’t}](#brainstorming-techniques-what-worked-and-what-didnt-brainstorming-techniques-what-worked-and-what-didnt)
      - [What Worked {#what-worked}](#what-worked-what-worked)
      - [What Didn’t Work {#what-didn’t-work}](#what-didnt-work-what-didnt-work)
    - [Process for Organizing and Ranking Ideas {#process-for-organizing-and-ranking-ideas}](#process-for-organizing-and-ranking-ideas-process-for-organizing-and-ranking-ideas)
      - [Organizing {#organizing}](#organizing-organizing)
      - [Ranking {#ranking}](#ranking-ranking)
      - [Concept Sketching {#concept-sketching}](#concept-sketching-concept-sketching)
    - [Justification for Final Specifications {#justification-for-final-specifications}](#justification-for-final-specifications-justification-for-final-specifications)
- [**Presentation 1** {#presentation-1}](#presentation-1-presentation-1)
- [**Selected Design** {#selected-design}](#selected-design-selected-design)
- [**block-diagram** {#block-diagram}](#block-diagram-block-diagram)
- [**component-selection** {#component-selection}](#component-selection-component-selection)
- [**microcontroller-selection** {#microcontroller-selection}](#microcontroller-selection-microcontroller-selection)
- [**software-proposal** {#software-proposal}](#software-proposal-software-proposal)
- [**hardware-proposal** {#hardware-proposal}](#hardware-proposal-hardware-proposal)
- [**Appendix** {#appendix}](#appendix-appendix)
- [**Assignments** {#assignments}](#assignments-assignments)
    - [Communication Channels and Procedures {#communication-channels-and-procedures}](#communication-channels-and-procedures-communication-channels-and-procedures)
    - [Meeting Schedule and Coordination {#meeting-schedule-and-coordination}](#meeting-schedule-and-coordination-meeting-schedule-and-coordination)
    - [Roles and Responsibilities {#roles-and-responsibilities}](#roles-and-responsibilities-roles-and-responsibilities)
    - [Team Coordination and Accountability {#team-coordination-and-accountability}](#team-coordination-and-accountability-team-coordination-and-accountability)
    - [Conflict Recognition and Resolution {#conflict-recognition-and-resolution}](#conflict-recognition-and-resolution-conflict-recognition-and-resolution)
  - [Conflicts will be resolved collectively, with team members voicing concerns and working towards a compromise.](#conflicts-will-be-resolved-collectively-with-team-members-voicing-concerns-and-working-towards-a-compromise)
...
| Houyu Zhang (Inactive)| alpaca_z | hzhan322@asu.edu |  
